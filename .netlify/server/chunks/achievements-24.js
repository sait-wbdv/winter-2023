...
/* src/lib/content/assessments/cpnt-265/achievements-2.md generated by Svelte v3.55.0 */
...
<section class="${"cards"}"><ul><li><strong>Card Completion: 5 points(ish)</strong><ul><li>Show that you’ve worked toward completing a Card on your task board. Scope of work should not be trivial. Aim for a couple hours of work.</li>
...
<li><strong>Frontend Framework Implementation: <em>10 points</em></strong><ul><li>Implement a sample app using one of the following frameworks:<ul><li>ReactJS</li>
<li>VueJS components not covered in class<ul><li>Example: <a href="${"https://stackoverflow.com/questions/70275889/how-to-build-an-intersectionobserver-in-composition-api"}" rel="${"nofollow"}">How to build an IntersectionObserver in Composition API</a><ul><li>See: <a href="${"https://www.youtube.com/watch?v=T8EYosX4NOo"}" rel="${"nofollow"}">Introduction to the Intersection Observer JavaScript API</a> by Kevin Powell</li></ul></li></ul></li>
<li>Svelte</li>
...
<li>Lighthouse performance tests</li>
<li>Postman API tests</li>
<li>etc</li></ul></li></ul></section>
<hr>
<h2 id="${"devops"}"><a aria-hidden="${"true"}" tabindex="${"-1"}" href="${"#devops"}"><span class="${"icon icon-link"}"></span></a>Devops</h2>

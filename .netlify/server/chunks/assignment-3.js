...
/* src/lib/content/assessments/cpnt-201/assignment-3.md generated by Svelte v3.55.0 */
...
<p>In groups of 2-3, practice creating and resolving merge conflicts in a codebase. This is a small but very important skill to practice as when you are working with other developers, merge conflicts will occur and you will be expected to be able to resolve them properly.</p>
...
<p>Once you’ve completed your pair-code session, each of you has resolved a merge conflict and pushed your up-to-date code to GitHub:</p>
...
<li>add a link to the specific commit that YOU pushed to resolve the conflict (it has two parents listed <a href="${"https://github.com/sait-wbdv/hello-conflict/commit/3accba9e0ec9abdbd542fc3ee05cf680fd792115"}" rel="${"nofollow"}">like this one</a>).</li></ul></li></ul>
...
<p>10 points will be given for each of the following criteria, for a total of 20 points for this assignment:</p>
<ol><li>Repo with two collaborators<ul><li>repo is named <code>cpnt201-a3</code>;</li>
...
<li>Merge Commit:<ul><li>A link to the specific merge commit is provided with submission.</li>

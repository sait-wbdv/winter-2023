...
/* src/lib/content/assessments/cpnt-265/achievements-1.md generated by Svelte v3.55.0 */
...
<hr>
<h2 id="${"project-documentation"}"><a aria-hidden="${"true"}" tabindex="${"-1"}" href="${"#project-documentation"}"><span class="${"icon icon-link"}"></span></a>Project Documentation</h2>

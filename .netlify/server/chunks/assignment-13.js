...
/* src/lib/content/assessments/cpnt-260/assignment-1.md generated by Svelte v3.55.0 */
...
const Assignment_1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	return `<p>In this assignment, you will be creating a column of body text with HTML and CSS. The content should be original. While you can use open-source content as inspiration, it should be unique and on-topic.</p>
...
<li>a entry for your coding journal.</li></ul>
...
<ol><li>Write at least 150 words (to a maximum of 300 words) on your topic;</li>
...
<li>Place your content in a validated HTML file named <code>index.html</code> (CSS may be embedded in a <code>style</code> element in the <code>head</code> of <code>index.html</code>).</li></ol>
...
<li class="${"task-list-item"}"><input type="${"checkbox"}" disabled> Line length should not exceed 65 characters on wide screens;</li>
<li class="${"task-list-item"}"><input type="${"checkbox"}" disabled> Content should be centred on wide screens;</li>
...
<li class="${"task-list-item"}"><input type="${"checkbox"}" disabled> Ensure that all fonts are defined with proper fallbacks;</li>
...
<li>Google Fonts for your typefaces, OR;</li>

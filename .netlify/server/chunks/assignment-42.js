...
/* src/lib/content/assessments/cpnt-260/assignment-4.md generated by Svelte v3.55.0 */
...
<ul class="${"contains-task-list"}"><li class="${"task-list-item"}"><input type="${"checkbox"}" disabled> Display and Text fonts should not be default and have proper fallbacks;</li>
<li class="${"task-list-item"}"><input type="${"checkbox"}" disabled> “60-30-10” colour scheme (or similar) used for neutral/base (60%), primary(30%) and Call-to-Action (10%) colours;</li>
...
<li class="${"task-list-item"}"><input type="${"checkbox"}" disabled> There should be a custom colour defined for Call-to-Action link (see “60-30-10” comment above);</li>
...
<ul><li>Host your images locally in an <code>images</code> directory in your project, OR;</li>
<li>A project board (conforming to <a href="${"https://sait-wbdv-f22.netlify.app/courses/cpnt-260/assessments/achievements-2#project-board"}" rel="${"nofollow"}">Achievements Round 2 requirements</a>) that you used to manage your work on this assignment (this cannot a board previously submitted as an achievement), OR;</li>
...
<ul><li>Push this assignment to a GitHub repo named <code>cpnt260-a4</code> and enable GitHub Pages;</li>
